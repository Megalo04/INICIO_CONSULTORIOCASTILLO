          ...
          <div className="d-flex align-items-center justify-content-between mb-4">
            <Link to="/Reservar" className="text-decoration-none">
              <Button variant="link" className="d-flex align-items-center">
                <i className="feather" data-feather="arrow-left" style={{ fontSize: '20px', border: '1px solid black', padding: '5px', borderRadius: '50%' }}></i>
              </Button>
            </Link>
  ...
  return (
    <Form onSubmit={handleYapePayment}>
      ...
      {paymentApproved ? (
        ...
        <Button variant="primary" type="submit" className="w-100">Pagar con Yape</Button>
      )}
    </Form>
  );
};
...
const CardForm = () => (
  <Form>
    <Form.Group controlId="cardName" className="mb-3">
      ...
      <Form.Control type="text" placeholder="Nombre que figura en la tarjeta" style={{ color: '#0A2045' }} />
    </Form.Group>
    <Form.Group controlId="cardNumber" className="mb-3">
      <Form.Label>Número de Tarjeta</Form.Label>
      <Form.Control type="text" placeholder="XXXX-XXXX-XXXX-XXXX" style={{ color: '#0A2045' }} />
    </Form.Group>
    <Form.Group controlId="cardExpiry" className="mb-3">
      <Form.Label>Fecha de Expiración</Form.Label>
      <Form.Control type="text" placeholder="MM/AA" style={{ color: '#0A2045' }} />
    </Form.Group>
    <Form.Group controlId="cardCVC" className="mb-3">
      <Form.Label>CVC</Form.Label>
      <Form.Control type="text" placeholder="CVC" style={{ color: '#0A2045' }} />
    </Form.Group>
    <Button
      variant="primary"
      type="submit"
